...
public:	  
    ...
    // inline INTEGRAL_IMAGE& operator()(int x, int y) {return img[y*(width+padding)+(x+padding)];} // setter
    // inline INTEGRAL_IMAGE  operator()(int x, int y) const {return img[y*(width+padding*2)+(x+padding)];} // accessor
